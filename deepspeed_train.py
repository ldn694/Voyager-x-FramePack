...
from voyager.modules.double_branch import apply_double_branch_to_hunyuan_video, get_double_branch_parameters, get_double_branch_state_dict, TransformerBranchConfig
        ...
        for step, data in pbar:
            ...
            if model_input_cache is not None:
                ...
                if valid_tensor.item() < 1.0:
                    ...
                    batch = [ground_truth_rgb_depths, latents]
